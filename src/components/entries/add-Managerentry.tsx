...
import { toast } from "react-toastify";
 const AddManagerEntryModal= function ({getEntries}:{getEntries:()=>void}) {
    ...
    const onSubmit =async (data: EntryInputs) =>{
      console.log(data);
      const res=await api.post('/manager/add-entry',JSON.stringify({...data,date:formatedDate}),{headers:{'Content-Type':'application/json'}});
      ...
      <>
        ...
        <Modal onClose={() => setOpen(false)} show={isOpen}>
          <Modal.Header className="border-b border-gray-200 !p-6 dark:border-gray-700">
            <strong>Add Manager Entry</strong>
          </Modal.Header>
  ...
  export default AddManagerEntryModal