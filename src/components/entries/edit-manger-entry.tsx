...
const EditManagerEntryModal = function ({entry,entryId,getEntries}:{entry:EntryInputs,entryId:string,getEntries:any}) {
   ...
   //form Submit handler
    const onSubmit=async(data:EntryInputs)=>{
      console.log(JSON.stringify(data)+"data")
       const res=await api.put(`/manager/update-entry/${entryId}`,JSON.stringify(data),{headers:{'Content-Type':'application/json'}});
