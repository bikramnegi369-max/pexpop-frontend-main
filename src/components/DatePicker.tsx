...
const DatePicker: FC<Props> = ({ value, onChange, placeholder = "Select a date", hasError }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className={`flex-1 text-sm ${display ? "font-medium text-gray-800 dark:text-white" : "text-gray-400 dark:text-gray-500"}`}>
          {display || placeholder}
        </span>
        <svg
          ...
          {isMobile && (
            <div className="bottom-sheet-enter fixed inset-x-0 bottom-0 z-50 rounded-t-2xl bg-white shadow-2xl dark:bg-gray-900">
              ...
              <div className="flex items-center justify-between border-b border-gray-100 px-5 py-3 dark:border-gray-700">
                <span className="text-base font-semibold text-gray-900 dark:text-white">Select Date</span>
                <button
                  onClick={() => setOpen(false)}
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
              <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-800">
                <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4 dark:border-gray-700">
                  <div>
                    <p className="text-sm font-semibold text-gray-900 dark:text-white">Select Date</p>
