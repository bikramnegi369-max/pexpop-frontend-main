    ...
    <>
      ...
      <Modal onClose={() => setOpen(false)} show={isOpen}>
        ...
        <Modal.Body className="h-96 overflow-auto">
          <Calendar onChange={(e) => handleDate(e)} className="w-full h-full" />
        </Modal.Body>
        <Modal.Footer>
...
const ProductsTable: FC<ProductTableProps> = function ({ entries, getEntries }: ProductTableProps) {
  ...
  return (
    <>
      ...
      <div className="text-center gap-4 flex justify-center pb-5 pt-5">
        <button className="p-2 px-5 bg-primary-200 rounded-xl" onClick={() => goToPrev()}>
          back
        </button>
        ...
        <button className="p-2 px-5 bg-green-200 rounded-xl" onClick={() => goToNext()}>
          Next
        </button>
      </div>
    </>
