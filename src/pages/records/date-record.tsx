                      ...
                      <li className="py-3 sm:py-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="inline-flex items-center gap-3 text-base font-semibold text-gray-900 dark:text-white">
                            <Button color="success" onClick={() => navigate(`/entries-by-date/${dateFormat(dateRecord.date, "dd-mmm-yyyy")}`)}> Go to Entries</Button>
                            <EditDateModal dateRecord={dateRecord} dateRecordId={dateRecord.id} getDateRecords={getDateRecords} />
                            <DeleteDateModal dateRecordId={dateRecord.id} getDateRecords={getDateRecords} />
                          </div>
                        </div>
                      </li>
                    )}
